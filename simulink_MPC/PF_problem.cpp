...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    ocp1.subjectTo((-4.72222222222222214327e+01) <= vx <= 4.72222222222222214327e+01);
    ...
    ocp1.subjectTo((-8.33849999999999980105e+00) <= (dot(vy)+r*vx) <= 8.33849999999999980105e+00);
    ocp1.subjectTo((-1.08935745260840888271e+00) <= delta <= 1.08935745260840888271e+00);
    ocp1.subjectTo((-9.06664546490560829817e-01) <= d_delta <= 9.06664546490560829817e-01);
    DifferentialEquation acadodata_f3;
    acadodata_f3 << dot(vx) == (1/1.38000000000000000000e+03/3.03499999999999992006e-01*T_wheel+r*vy);
    ...
    acadodata_f3 << dot(r) == (1.01060000000000000000e+05/2.63450000000000000000e+03/vx*vy+1.66080000000000000000e+05/2.63450000000000000000e+03*delta-1/2.63450000000000000000e+03*6.05453560000000055879e+05*r/vx);
