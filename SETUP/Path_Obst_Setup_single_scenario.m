%This file is similar to Path_Obst_Setup but here you can select one
%specific scenario to change. 
clear all; clc; close all;
%Define case as scenario to replace
icase = 6;
i = 1;
save_scenarios = true;
